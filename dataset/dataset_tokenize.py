...
class VQMotionDataset_old(Dataset):
...
def DATALoaderNew(dataset_name, type, batch_size=1, num_workers=8, unit_length=4, shuffle=True):
...
def DATALoader(dataset_name,
    ...
    train_loader = DataLoader(
        VQMotionDataset_old(dataset_name, unit_length=unit_length, fill_max_len=batch_size != 1),
        batch_size,
        shuffle=shuffle,
